...
public partial class ITableDbContext : DbContext
{
    ...
    public virtual DbSet<RestaurantBusinessHour> RestaurantBusinessHours { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Restaurant>(entity =>
        {
            ...
            entity.Property(e => e.BusinessHoursEnd).HasPrecision(0);
            entity.Property(e => e.BusinessHoursStart).HasPrecision(0);
        ...
        {
            entity.HasKey(e => e.BusinessHourId).HasName("PK__Restaura__D34018BC6385ACAB");

            entity.Property(e => e.BusinessHourId)
                .HasComment("營業時間的唯一識別碼，主鍵（PK），自動遞增。此欄位用於唯一標識每個營業時間紀錄，並在資料表之間建立關聯。")
                .HasColumnName("BusinessHourID");
            entity.Property(e => e.CloseTime).HasComment("營業結束時間（前台 + 後台）。此欄位存儲餐廳每天的營業結束時間，供客戶查詢和預約使用。");
            entity.Property(e => e.CreatedAt)
                .HasPrecision(0)
                .HasComment("資料建立時間（前台 + 後台）。此欄位記錄營業時間紀錄的建立時間，用於審計和管理。");
            entity.Property(e => e.OpenTime).HasComment("營業開始時間（前台 + 後台）。此欄位存儲餐廳每天的營業開始時間，供客戶查詢和預約使用。");
            entity.Property(e => e.RestaurantId)
                .HasComment("餐廳ID，外鍵（FK）連結到 Restaurants 表（前台 + 後台）。此欄位指定該營業時間所屬的餐廳。")
                .HasColumnName("RestaurantID");
            entity.Property(e => e.UpdatedAt)
                .HasPrecision(0)
                .HasComment("資料更新時間（前台 + 後台）。此欄位記錄營業時間紀錄的最後更新時間，用於追蹤資料變更歷史。");
            entity.Property(e => e.WeekDay).HasComment("星期幾（1-7，1 代表星期一）（前台 + 後台）。此欄位指定營業時間適用的星期幾，方便客戶查詢。");

            entity.HasOne(d => d.Restaurant).WithMany(p => p.RestaurantBusinessHours)
                .HasForeignKey(d => d.RestaurantId)
                .HasConstraintName("FK_RestaurantBusinessHours_Restaurants");
        });
